...
// let names : string [] = ["Jamshed" , "Ale", "Asad"];
// let message : string = " Do you like to play football?"
// console.log(names[0] + message);
// console.log(names[1] + message);
// console.log(names[2] + message);
...
// Question 13 
/*
let transportation : string [] = ["Honda Motorcycle" , "Audi" , "BMW"];
...
// let book : {title: string; author: string; yeatpublished: number } = {
//     title: "The Hobbit", 
//     author: "J.R.R. Tolkien",
//     yeatpublished: 1937
// };
// console.log(`Book Info: ${book.title} by ${book.author}, published in ${book.yeatpublished}.`);
